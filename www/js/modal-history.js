...
/**
 * (إصلاح باج حقيقي "زرار الرجوع بيقفل التطبيق" - محاولة تانية):
 * بترجع true لو فيه مودال مفتوح فعلاً دلوقتي. js/back-button.js
 * بيستخدمها عشان يقرر لوحده (من غير ما يعتمد على canGoBack بتاع
 * Capacitor الأصلي خالص - شوف تعليق back-button.js للتفاصيل الكاملة
 * عن ليه اتضح إنه مش موثوق فيه حتى بعد إصلاح الـ Hash Fragment فوق)
 * هل يقفل آخر مودال ولا يخرج من التطبيق
 * @returns {boolean}
 */
